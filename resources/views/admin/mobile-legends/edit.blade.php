                                    ...
                                    <div class="col-12">
                                        <div class="dashboard-card">
                                            ...
                                            <div class="registration-form">
                                                <form class="text-light" action="{{ url('admin/mobile-legends-team/'.$team->id) }}" method="post" enctype="multipart/form-data">
                                                    @method('patch')
                                                    @csrf
                                                    ...
                                                    <div class="form-container">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control costume-form @error('nama{{$loop->iteration}}') is-invalid @enderror" value="{{ $item->name }}" id="nama{{$loop->iteration}}" name="nama{{$loop->iteration}}" placeholder="Nama ..." >
