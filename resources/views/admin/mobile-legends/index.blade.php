                                    ...
                                    <div class="col-12">
                                        <div class="dashboard-card">
                                            ...
                                            <div class="img-container text-center">
                                                <img src="../../img/logo-ml.png" alt="" class="img-fluid">
                                            </div>
                                                ...
                                                <div class="team-card">
                                                    <div class="text-container  d-flex align-items-center text-light p-2 justify-content-between w-100">
                                                        ...
                                                        <div class="team-action">
                                                            <a href="{{ url('admin/mobile-legends-team/detail/'.$item->id) }}" class="btn btn-warning">View</a>
                                                            <a href="{{ url('admin/mobile-legends-team/edit/'.$item->id) }}" class="btn btn-primary">Edit</a>
                                                            <form action="{{ url('admin/mobile-legends-team/'.$item->id) }}" method="POST" class="d-inline">
                                                                @method('delete')
                                                                @csrf
