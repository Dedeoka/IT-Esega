                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ml-auto">
                                <li class="nav-item d-block d-md-none">
                                    <a class="nav-link" href="{{ route('mole-admin') }}">Valorant</a>
                                </li>
                                <li class="nav-item d-block d-md-none">
                                    <a class="nav-link" href="{{ route('mole-admin') }}">Mobile Legend</a>
                                </li>
                                <li class="nav-item d-block d-md-none">
                                    <a class="nav-link" href="{{ route('dashboard') }}">">Information</a>
                                </li>
                                <li class="nav-item">
                            ...
                            <nav class="d-none d-md-block bg-light sidebar h-100">
                                <div class="sidebar-sticky">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link @if(Route::is('valo-admin')) active @endif" href="{{ route('valo-admin') }}">
                                                <span data-feather="home"></span>
                                                Valorant
                                                <span class="sr-only">(current)</span>
                                            </a>
                                        </li>
                                        <li class="nav-item @if(Route::is('mole-admin')) active @endif">
                                            <a class="nav-link" href="{{ route('mole-admin') }}">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link @if(Route::is('pesan')) active @endif" href="{{ route('pesan') }}">
                                                <span data-feather="file"></span>
                                                Pesan
                                            </a>
                                        </li>
