                                    ...
                                    <div class="col-12">
                                        <div class="dashboard-card">
                                            <div class="text-container text-light text-center">
                                                <h1 class="mb-3">Valorant Registration</h1>
                                            </div>
                                            <div class="registration-form">
                                                <form class="text-light" action="{{ route('add-valo') }}" method="post" enctype="multipart/form-data">
                                                    @csrf
                                                    ...
                                                    <div class="form-container">
                                                        <div class="custom-file my-3">
                                                            <input type="file" class="custom-file-input @error('buktiBayar') is-invalid @enderror" id="buktiBayar" name="buktiBayar" >
                                                            <label class="custom-file-label costume-form-file" for="buktiBayar">Masukan Bukti Pembayaran</label>
                                                            @error('buktiBayar')
                                                                <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                        </div>
                                                        <p>Bukti Transfer 100k ke (BNI 1232741889 A/N I GUSTI PUTU NGURAH PRIHANDANA)</p>
                                                    </div>
                                                    <div class="form-container">
                                                        <div class="text-container mt-5">
                                                            Pemain 1
                                                        </div>
                                                        <p>note : Foto peserta dan foto tanda tangan digunakan untuk kepentingan absensi dan registrasi</p>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            <input type="text" class="form-control costume-form @error('tagKetua') is-invalid @enderror" value="{{ old('tagKetua') }}" id="tagKetua" name="tagKetua" placeholder="Tagline ..." >
                                                            @error('tagKetua')
                                                                <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="form-container">
                                                        ...
                                                        <div class="form-group">
                                                            <input type="text" class="form-control costume-form @error('tag2') is-invalid @enderror" value="{{ old('tag2') }}" id="tag2" name="tag2" placeholder="Tagline ..." >
                                                            @error('tag2')
                                                                <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="form-container">
                                                        ...
                                                        <div class="form-group">
                                                            <input type="text" class="form-control costume-form @error('tag3') is-invalid @enderror" value="{{ old('tag3') }}" id="tag3" name="tag3" placeholder="Tagline ..." >
                                                            @error('tag3')
                                                                <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="form-container">
                                                        ...
                                                        <div class="form-group">
                                                            <input type="text" class="form-control costume-form @error('tag4') is-invalid @enderror" value="{{ old('tag4') }}" id="tag4" name="tag4" placeholder="Tagline ..." >
                                                            @error('tag4')
                                                                <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="form-container">
                                                        ...
                                                        <div class="form-group">
                                                            <input type="text" class="form-control costume-form @error('tag5') is-invalid @enderror" value="{{ old('tag5') }}" id="tag5" name="tag5" placeholder="Tagline ..." >
                                                            @error('tag5')
                                                                <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="form-container">
                                                        <div class="text-container mt-5">
                                                            Pemain Cadangan 1 <br/> Jika tidak ada cadangan form diisi dengan - <br/> Form foto dan tanda tangan diisi dengan foto bebas
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            <input type="text" class="form-control costume-form @error('tag6') is-invalid @enderror" value="{{ old('tag6') }}" id="tag6" name="tag6" placeholder="Tagline ..." >
                                                            @error('tag6')
                                                                <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="form-container">
                                                        <div class="text-container mt-5">
                                                            Pemain Cadangan 2 <br/>Jika tidak ada cadangan form diisi dengan - <br/> Form foto dan tanda tangan diisi dengan foto bebas
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            <input type="text" class="form-control costume-form @error('tag7') is-invalid @enderror" value="{{ old('tag7') }}" id="tag7" name="tag7" placeholder="Tagline ..." >
                                                            @error('tag7')
                                                                <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                        </div>
