                                    ...
                                    <div class="col-12">
                                        <div class="dashboard-card">
                                            <div class="text-container text-light text-center">
                                                <h1 class="mb-3">Your Mobile Legends Team</h1>
                                            </div>
                                                ...
                                                <div class="team-card">
                                                    <div class="text-container  d-flex align-items-center text-light p-2 justify-content-between w-100">
                                                        ...
                                                        <div class="team-action">
                                                            <a href="{{ url('mobile-legends-team/update/'.$item->id) }}" class="btn btn-primary">Upload Bukti Bayar</a>
                                                            <a href="{{ url('mobile-legends-team/detail/'.$item->id) }}" class="btn btn-warning">View</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                @endforeach
